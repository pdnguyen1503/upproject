            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="{{asset('public/client')}}/img/banner10.jpg" alt="">
                ...
                <div class="col-md-4 col-sm-6">
                    <a class="banner banner-1" href="#">
                        <img src="{{asset('public/client')}}/img/banner11.jpg" alt="">
                        <div class="banner-caption text-center">
                            <h2 class="white-color">NEW COLLECTION</h2>
                        </div>
                    </a>
                ...
                <div class="col-md-4 col-md-offset-0 col-sm-6 col-sm-offset-3">
                    <a class="banner banner-1" href="#">
                        <img src="{{asset('public/client')}}/img/banner12.jpg" alt="">
                        <div class="banner-caption text-center">
                            <h2 class="white-color">NEW COLLECTION</h2>
                        </div>
                    </a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    <div class="banner banner-2">
                        <img src="{{asset('public/client')}}/img/banner14.jpg" alt="">
                        ...
                        <div id="product-slick-1" class="product-slick">
                            ...
                            <div class="product product-single">
                                <div class="product-thumb">
                                    ...
                                    <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                                    <img src="{{asset('public/client')}}/img/product08.jpg" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                                    <div class="product-rating">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="banner banner-1">
                        <img src="{{asset('public/client')}}/img/banner13.jpg" alt="">
                        <div class="banner-caption text-center">
